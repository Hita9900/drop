        ...
        <>
            ...
            <div className="p-4 mx-auto max-w-xl">
                ...
                {votedSongs.length === 0 && notVotedSongs.length === 0 ?
                    <div className="p-4 pt-10"><Frown size={30} />
                        <p className="pt-3">Nobody has submitted anything yet</p>
                        <p className="text-small opacity-80">except you of course</p>
                    </div>
                    :
                    <div className="glass-bg my-12 p-6 rounded-xl">
                        <h3 className='font-wildworld text-header'>VOTING</h3>
                        <p className="font-light text-small opacity-80">more songs will be added throughout the day</p>
                        <div className="flex text-small font-medium"><span className="mt-[4px]"><InfoIcon size={16} color="var(--color-primary-accent)" /></span><p>&nbsp;you can’t take back your votes!</p></div>
                    </div>
                }
